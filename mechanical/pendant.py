...
def gen_step():
    ...
    cradle-=block(3,3,2,motor_x,motor_y+5.5,-rear+wall-.1)
    base+=cradle
    parts=[named(motor,'REFERENCE offboard QX1027 motor maximum envelope'),named(adhesive,'Motor adhesive interface — provisional'),named(base,'01 Rear chassis — PA12'),named(lid,'02 Front cover — PA12'),
    ...
    for ref,height in [('U1',4),('J4',1.42),('J1',8),('J3',8)]:
        ...
        else:shape=block(e['maxX']-e['minX'],e['maxY']-e['minY'],height,(e['minX']+e['maxX'])/2,(e['minY']+e['maxY'])/2,-height if a['side']=='bottom' else t)
